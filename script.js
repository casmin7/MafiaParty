...
function renderPlayers() {
  ...
  if (currentStage === "SETUP") {
    ...
    const pencilIcon = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const lockIcon = `<svg viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M17 9.32001V7.32001C17 5.99392 16.4732 4.72217 15.5355 3.78448C14.5978 2.8468 13.3261 2.32001 12 2.32001" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`;

    if (editStatusText) {
      editStatusText.innerHTML = editing
        ? `${lockIcon}Done Editing`
